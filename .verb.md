...
Note that `{%= name %}` will work out-of-the-box in most cases and without problems. But in old environment which don't have support for native Promises there's 
